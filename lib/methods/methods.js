		...
		changeImgProfile(idImg, extImg){
			...
			Meteor.users.update(Meteor.userId(), {
				$set: {
					profile: {
						profileImage: newImg,
						subscriptions: Meteor.user().profile.subscriptions,
						nbSubscriptions: Meteor.user().profile.nbSubscriptions,
						readers: Meteor.user().profile.readers,
						nbReaders: Meteor.user().profile.nbReaders,
